// rather than having to target an element by document.getElement(s)By you cn use 
// the event object, which can be queried for element that event occurred on
// and then other elements can be targetted from this point, 
// using nextSibling, parentNode etc ....
